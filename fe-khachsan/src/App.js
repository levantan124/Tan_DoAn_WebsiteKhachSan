          ...
          <Layout>
            <Routes>
              ...
              <Route path="/admin" element={<Admin391 />}>
                ...
                <Route
                  path="existing-roomtypes"
                  element={<ExistingRoomTypes391 />}
                />
                <Route
                  path="existing-services"
                  element={<ExistingServices391 />}
                />
                <Route
                  path="existing-accounts"
                  element={<ExistingAccounts391 />}
                />
                <Route
                  path="existing-reservations"
                  element={<ExistingReservations391 />}
                />
...
const Layout = ({ children }) => {
  ...
  const isLoginOrSignupPage =
    pathname === "/login" || pathname === "/signup" || pathname === "/info";
